package com.xxxx.medusa.busyflights.domain.busyflights.gateways.toughjet;

import com.xxxx.medusa.busyflights.buildingblocks.ExchangeTrait;
...
public class ToughJetApi {
    ...
    public static class GET implements ExchangeTrait<List<ToughJetResponse>,
                ToughJetRequest> {
        @Override
